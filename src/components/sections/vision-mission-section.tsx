...
export function VisionMissionSection() {
  return (
    <section id="vision" className="w-full py-20 md:py-32 bg-primary/20">
      <div className="container px-4 md:px-6">
        <AnimatedSection>
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-headline text-accent">Vision &amp; Mission Of My Life.</h2>
        ...
        <div className="mx-auto grid max-w-5xl items-start gap-8 sm:grid-cols-1 md:grid-cols-3 md:gap-12 lg:max-w-none lg:gap-16 pt-12">
          <AnimatedSection delay={100}>
            <Card className="h-full bg-card/80 backdrop-blur-sm shadow-lg border-primary/20">
              <CardHeader>
                <CardTitle className="text-accent">Vision</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <AnimatedSection delay={200}>
            <Card className="h-full bg-card/80 backdrop-blur-sm shadow-lg border-primary/20">
              <CardHeader>
                <CardTitle className="text-accent">Make a Target</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <h3 className="font-semibold text-foreground">Short-Term Goal</h3>
                  <p className="text-muted-foreground">
                ...
                <div>
                  <h3 className="font-semibold text-foreground">Long-Term Goal</h3>
                  <p className="text-muted-foreground">
          ...
          <AnimatedSection delay={300}>
            <Card className="h-full bg-card/80 backdrop-blur-sm shadow-lg border-primary/20">
              <CardHeader>
                <CardTitle className="text-accent">Mission</CardTitle>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-muted-foreground">
                  <li className="flex items-start">
                    <CheckCircle2 className="mr-2 mt-1 h-4 w-4 flex-shrink-0 text-primary-foreground fill-primary" />
