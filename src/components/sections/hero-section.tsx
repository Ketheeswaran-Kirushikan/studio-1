        ...
        <div className="grid gap-8 lg:grid-cols-2 lg:gap-16 xl:gap-24 items-center">
          <div className="flex flex-col justify-center space-y-4 text-center lg:text-left animate-fade-in-up">
            ...
            <div className="w-full max-w-sm space-y-2 mx-auto lg:mx-0 pt-4">
                <a href="#portfolio">
                    <Button size="lg" className="w-full sm:w-auto bg-accent text-accent-foreground hover:bg-accent/90 transition-all duration-300 transform hover:scale-105 shadow-lg">
                        View My Work
          ...
          <div className="flex justify-center animate-fade-in-scale [animation-delay:200ms]">
            {heroImage && (
              <Image
                ...
                height={400}
                priority
                className="rounded-full object-cover aspect-square border-8 border-primary shadow-2xl"
              />
            )}
          </div>
        </div>
